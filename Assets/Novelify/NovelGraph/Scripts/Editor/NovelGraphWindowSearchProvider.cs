...
namespace NovelGraph.Editor
{
    ...
    public class NovelGraphWindowSearchProvider : ScriptableObject, ISearchWindowProvider
    {
        public NovelGraphView graph;
        ...
        public bool OnSelectEntry(SearchTreeEntry entry, SearchWindowContext context)
        {
            ...
            SearchContextElement element = (SearchContextElement)entry.userData;

            NovelGraphNode node = (NovelGraphNode)element.target;
